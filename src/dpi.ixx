...
export GetDpiForWindow_t pGetDpiForWindow = nullptr;
export SetProcessDpiAwarenessContext_t pSetProcessDpiAwarenessContext = nullptr;
export const HANDLE DPI_CTX_PER_MONITOR_V2 = ((HANDLE)(LONG_PTR)-4);

export void load_dpi_apis() {
